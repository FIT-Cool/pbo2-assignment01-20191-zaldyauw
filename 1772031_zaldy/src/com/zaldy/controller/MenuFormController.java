...
//                menus.add(i);
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        combocat.setItems(getCategories());
    ...
    public void ViewAllAct(ActionEvent actionEvent) {
        try {
            JasperPrint jp = JasperFillManager.fillReport("report/report1.jasper", new HashMap<>(), DBHelper.createMySQLConnection());
            JasperViewer viewer = new JasperViewer(jp, false);
            viewer.setTitle("Category Report");
    ...
    public void ViewSelectedAct(ActionEvent actionEvent) {
        try {
            HashMap param = new HashMap();
            param.put("IdCat", combocat.getValue().getId());
